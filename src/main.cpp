...
int main(int argc, char** argv) {
    ...
    if (mode == "axpy") {
        ...
        append_csv(csv, info.rank, "axpy", "axpy", d.N_local, 0, 0, 0, ms, 0.0, gbs);
    ...
    // ══════════════════════════════════════════════════════════════════════════
        ...
        append_csv(csv, info.rank, "gemm", kernel, 0, M, Nmat, K, comp_ms, gflops, comm_ms);
        ...
        if (info.rank == 0)
            std::cerr << "Unknown mode '" << mode << "'. Use axpy|reduce|gemm.\n";
    }
